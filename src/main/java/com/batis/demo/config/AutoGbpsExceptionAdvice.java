...
import com.batis.demo.config.exception.ExceptionHandlerManager;
import com.batis.demo.config.exception.GbpsWebExConfigure;
import com.batis.demo.config.exception.ValidHandlerManager;
import com.batis.demo.config.log.DefaultWebExLogHandler;
...
class AutoGbpsExceptionAdvice implements ApplicationContextAware {
    ...
    @Autowired
    protected DefaultWebExLogHandler logHandler;
